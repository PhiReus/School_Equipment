        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label for="tf1">Ngày nhập liệu<abbr name="Trường bắt buộc">*</abbr></label>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select name="approved" class="form-control">
                                <option value="0" {{ $item->approved == '0' ? 'selected' : '' }}>Chưa xét duyệt</option>
                                ...
                                <tbody id="device_list">
                                    ...
                                    <tr>
                                        ...
                                        <td> {{ $device->device->name }}
                                            <input name="devices[id][]" type="hidden" value="{{$device->device_id}}">
                                        </td>
                                        <td>
                                            <input value="{{$device->lesson_name}}" name="devices[lesson_name][]"
                                                type="text" class="form-control input-sm">
                                        </td>
                                        <td width="100"> <input value="{{$device->quantity}}" name="devices[quantity][]"
                                        ...
                                        <td width="100">
                                            <input value="{{$device->lecture_name}}" name="devices[lecture_name][]"
                                                type="text" class="form-control input-sm">
                                        </td>
                                        <td>
                                            <select name="devices[room_id][]" class="form-control">
                                                <?php foreach ($rooms as $room): ?>
                                                <option @selected($room->id == $device->room_id)
                                                    value="<?php echo $room->id; ?>"><?php echo $room->name; ?>
                                                </option>
                                                <?php endforeach; ?>
                                            </select>
                                        </td>
                                        ...
                                        <td> <input value="{{$device->return_date}}" name="devices[return_date][]"
